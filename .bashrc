...
alias gt="git tag"
alias gbr="git for-each-ref --sort=-committerdate refs/heads/ --format='%(color:yellow)%(committerdate)%(color:reset) %(color:blue)%(authorname)%(color:reset) %(refname:short)'"
